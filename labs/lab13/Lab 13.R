...
# Copy the data file to the clipboard and then type the following instruction in R: Note don't copy th item column
...
rowpro<-abcde/apply(abcde,1,sum) # each row devided by row-sum 
rowpro 
